			...
			success: function(data) {
				...
				$.each(resArray, function(key, value) {
					...
					if(value['test_result'] == null){
						$("#test_table tbody").append("<tr id='tr_" + value['test_code'] + "'onclick='get_parameter(" + value['test_code'] + ")' class='teststatusentered'><td>" + i + "</td><td>" + value['test_name'] + "</td><td>"+value['method_name']+"</td><td>" + value['test_result'] + "</td><td>" + value['test_unit'] + "</td></tr>");
					
					}else{
						$("#test_table tbody").append("<tr id='tr_" + value['test_code'] + "'onclick='get_parameter(" + value['test_code'] + ")' class='teststatustobe'><td>" + i + "</td><td>" + value['test_name'] + "</td><td>"+value['method_name']+"</td><td>" + value['test_result'] + "</td><td>" + value['test_unit'] + "</td></tr>");
