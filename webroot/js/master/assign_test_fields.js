$(document).ready(function(){
    ...
    $("#finalize").click(function(){
    	...
    	if(!confirm("Do u want to finalize field?"))
		{
			location.reload();							
			...
			$.ajax({
				type: "POST",						
				url: 'finalize-assign-test-fields',
				data:{test_code:test_code},
				beforeSend: function (xhr) { // Add this line
			          xhr.setRequestHeader('X-CSRF-Token', $('[name="_csrfToken"]').val());
			    },
				success: function (data) {
					...
					if(data=='1')
					{
						var msg="Fields has finalized successfully";
						alert(msg);
						location.replace('test_fields');
					...
					{
						var msg="Error in finalized fields";
						alert(msg);
