			...
			success: function (data) {
				...
				if(resArray.indexOf('[error]') !== -1){
					...
					if(resArray.indexOf('Exists') !== -1){
						...
						if( sess_user_flag == 'RAL' && sess_role == 'Inward Officer' ){
						...
						} else if( sess_user_flag == 'RAL' && sess_role == 'Lab Incharge') {
						...
						}else if(sess_user_flag == 'CAL' && sess_role == 'Lab Incharge'){
						...
						}else if(sess_user_flag == 'CAL' && sess_role == 'Inward Officer'){
