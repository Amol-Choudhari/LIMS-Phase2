$(document).ready(function(){
	...
	//To Save the DIV on the close - Akash[26-11-2019] 
	$('#save').hide();
	$("#menubuttons").hide();
	...
	//GLOBAL VARIABLE
	var user_flag = $("#sess_user_flag").val();
	var user_role = $("#sess_role").val();
			...
			success: function (data) {
				...
				if(resArray.indexOf('[error]') !== -1){
					...
					if(resArray.indexOf('Exists') !== -1){
						...
						if (user_flag == 'RAL' && user_role == 'Inward Officer') {
						...
						} else if (user_flag == 'RAL' && user_role == 'Lab Incharge') {
						...
						} else if (user_flag == 'CAL' && user_role == 'Lab Incharge') {
						...
						} else if (user_flag == 'CAL' && user_role == 'Inward Officer') {
	...
	//Click evnets are adjusted for the show hide buttons - Akash [26-11-2019]
