...
class ReporticoDataSource extends ReporticoObject
{
    ...
    public function pdoDriversAsString()
    {
		...
		return (implode(",",$drivers));//changed from implode syntax as written incorrect on 02-03-2022 by Amol
    }
	...
	// then instantite the class mentioned and pass in the credentials
        ...
        if ( $this->connection_string ) {
            ...
            if (class_exists('PDO', false)) {
                if (!$this->pdoDriverExists("pgsql")) {//changed from "mysql" to "pgsql" on 02-03-2022 by Amol
