...
<div id="reportico-top-margin" class="reportico-top-margin">t</div><!-- Created css of class reportico-top-margin and saved in themes\bootstrasp4\reportico.css -->
<div id="reportico-bottom-margin" class="reportico-bottom-margin">b</div><!-- Created css of class reportico-bottom-margin and saved in themes\bootstrasp4\reportico.css -->
