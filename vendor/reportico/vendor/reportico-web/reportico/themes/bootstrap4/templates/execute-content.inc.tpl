    ...
    {% for row in page.rows %}
        ...
        {% if row.closerowsection %}
            ...
            {% for group in row.groupends %}
                {% for trailer in group.trailers %}
                    <!--<tr class="trailer reportico-row reportico-trailer"> Removed class reportico-row by Shweta Apale 21-10-2021 to avoid extra border in table-->
					<tr class="trailer reportico-trailer">
        ...
        {% for group in row.groupends %}
            {% for trailer in group.customtrailers %}
				...
				<!--<div class="reportico-custom-trailer">-->
                    {% if ( trailer.image ) %}
