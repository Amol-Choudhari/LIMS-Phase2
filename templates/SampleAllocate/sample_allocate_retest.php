...
<?php echo $this->Html->css("sampleAllocate/sample-reallocate"); ?>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Sample Allocate Retest</li>
					</ol>
				</div>
			</div>
		</div>
					...
					<div class="col-md-12">
						<?php echo $this->Form->create(null, array('id'=>'frm_sample_allocate','class'=>'form-group')); ?>
							<div class="card card-lims">
								<div class="card-header"><h3 class="card-title-new">Allocate Sample to Chemist for Retest</h3></div>
								<div class="form-horizontal">
									<div class="card-body">
										<?php if (!empty($validate_err)){ ?><div class="alert alert-danger vr"><?php echo $validate_err; ?></div><?php } ?>
										<div class="row p-2">
											<?php
											...
											<div class="col-md-12 mt-3">
												<div class="row">
													...
													<div class="col-md-2">
														...
														<div class="colmd-12">
															<label><input type="radio" id="test_n_r"  name="test_n_r" value="R"  disabled required class='test_n_r_n_r' checked="checked"> Retest</label>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="card-footer">
									<div class="col-md-12">
										<?php echo $this->Form->submit('Allocate', array('name'=>'save', 'id'=>'save', 'label'=>false,'class'=>'btn btn-success float-left')); ?>
										<a href="../SampleAllocate/available_to_allocate" class="btn btn-danger float-right">Cancel</a>
									</div>
								</div>
							</div>
	...
	<?php echo $this->Html->Script('sample_allocate_retest_form'); ?>
	<?php echo $this->Html->Script('sampleAllocate/sample-reallocate'); ?>
