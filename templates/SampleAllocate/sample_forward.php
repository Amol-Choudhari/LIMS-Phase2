								...
								<div class="form-horizontal">
									<?php if (!empty($validate_err)) { ?><div class="alert alert-danger"><?php echo $validate_err; ?></div><?php } ?>
										...
										<div class="card-footer">
											<div class="col-md-12">
												<div class="col-md-2 float-left"><?php echo $this->Form->submit('Forward', array('name'=>'save', 'id'=>'save', 'label'=>false,'class'=>'form-control btn btn-success')); ?></div>
												<div class="col-md-2 float-right"><a href="../SampleAllocate/available_to_allocate" class="form-control btn btn-danger">Cancel</a></div>
											</div>
										</div>
									</div>
