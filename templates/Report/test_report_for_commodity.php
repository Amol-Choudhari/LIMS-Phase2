					...
					<div class="col-md-12">
						...
						<div class="card card-lims">
							<div class="card-header">
								<h3 class="card-title-new">Test Report for Commodity</h3>
							</div>
							<div class="card-body" id="avb">
								<table class="table table-striped table-hover table-bordered" id="testReport">
									...
									<tbody class="tableBody">
										...
										?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><?php echo $record['org_sample_code']; ?></td>
												<td><?php echo $record['tran_date']; ?></td>
												<td><?php echo $record['category_name']; ?></td>
												<td><?php echo $record['commodity_name']; ?></td>
												<td><?php echo $record['sample_type_desc']; ?></td>
												<td><a href="<?php echo $record['report_pdf']; ?>" target='_blank' class="btn btn-info">View</a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
...
<?php } else { ?>
	...
	<table width="100%" border="1">
			...
			<td align="center">
				...
				if ($test_report[0]['grade_user_flag'] == "CAL") { ?>
					...
					<h5><span style="font-family: krutidev010;">dsanzh; ,xekdZ ç;ksx“kkyk</span> / Central Agmark Laboratory<br />
						...
						Phone:0712-2561748,Fax: 0712-2540952 T-2315 mail:cal@nic.in
					</h5>
		...
		<tr>
			<td align="right">Date: <?php echo $sample_final_date; ?></td>
		</tr>

		<tr>
			<td align="center">
				<h5>Test Report For <?php if (isset($test_report)) {
										echo $test_report[0]['commodity_name'] . "(" . $test_report[0]['category_name'] . ")";
									} ?></h5>
			</td>
		</tr>
	...
	<table width="100%" border="1">
		<tr>
			...
			<td><?php if (isset($test_report)) {
					echo $test_report[0]['report_no'];
				} ?></td>
		</tr>
		<tr>
			<td><span style="font-family: krutidev010; font-size:10px;">xzkgd dk uke v©j irk</span> / Name and Address of customer</td>
			<td><b><?php if (!empty($sample_forwarded_office)) {
						echo $sample_forwarded_office[0]['user_flag'] . "," . $sample_forwarded_office[0]['ro_office'];
					} ?></b></td>
		</tr>
		<tr>
			...
			<td> <?php if (isset($test_report)) {
						echo $test_report[0]['commodity_name'] . "(" . $test_report[0]['category_name'] . ")"; ?> <b><?php echo $test_report[0]['sample_type_desc'];
																													} ?></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?php if (isset($test_report)) {
					echo $test_report[0]['sample_total_qnt'] . " " . $test_report[0]['unit_weight'];
				} ?></td>
		</tr>
		<tr>
			...
			<td><?php if (isset($test_report)) {
					echo $test_report[0]['phy_accept_sample_date'];
				} ?></td>
		</tr>
		...
		<tr>
			...
			<td><?php if (isset($test_report) && $test_report[0]['grade_user_flag'] == "RAL") {
					echo $test_report[0]['ral_anltc_rslt_rcpt_dt'];
				} else {
					echo $test_report[0]['cal_anltc_rslt_rcpt_dt'];
				} ?></td>
		</tr>
	</table>
	...
	<table width="100%" border="1">
		...
		<tr>
			...
			<td>5. Test sample is not drawn by this laboratory.</td>
		</tr>
	</table>
	...
	<table width="100%" border="1">
		<tr>
			...
			<td colspan="<?php if (isset($commo_grade)) {
								echo count($commo_grade);
							} ?>"><b><span style="font-family: krutidev010; font-size:10px;">fofunsZ'kks dh jsat</span>/Range of Specification</b></td>
	...
	<table border="1" width="100%">
		<tr>
			<td><b>Grade</b></td>
			<td><b><?php if (isset($test_report)) {
						echo $test_report[0]['grade_desc'];
					} ?></b></td>
		</tr>
	</table>
	<br>
	...
	<table width="100%">
		<tr>
			<td></td>
			<td align="right"><b>(Authorized Signatory/Incharge)</b> <br><br> <?php if (isset($test_report)) {
																					echo $test_report[0]['grade_user_flag'] . ',' . $test_report[0]['ro_office'];
																				} ?></td>
		</tr>
	</table>
<?php
