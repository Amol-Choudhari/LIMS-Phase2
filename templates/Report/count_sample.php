						...
						<div class="panel panel-default">
							...
							<div id="panel<?php echo $label1['label_code']; ?>" class="panel-collapse collapse">
								<div class="panel-body label-desc text-center">
									...
									?>
										<?php if($report1['report_desc'] == 'Brought forward,Analysed and carried forward of samples') { ?>
											<p class="badge border bg-dark"><label for="<?php echo $report1['report_desc']; ?>" id="<?php echo $report1['report_desc']; ?>" class="<?php echo $report1['report_desc']; ?>  control-label open-model" data-toggle="modal" data-target="#exampleModal"><span class="label-text"><?php echo 'Statement of Check Samples Brought forward/ Carry forward Annexure I'; ?></span></label></p><?php
										} 
										else if($report1['report_desc'] == 'Time Taken for Analysis of Samples') { ?>
											<p class="badge border bg-dark"><label for="<?php echo $report1['report_desc']; ?>" id="<?php echo $report1['report_desc']; ?>" class="<?php echo $report1['report_desc']; ?>  control-label open-model" data-toggle="modal" data-target="#exampleModal"><span class="label-text"><?php echo 'Time Taken report'; ?></span></label></p><?php
										} 
										else if($report1['report_desc'] == 'Chemist –wise sample analysis') { ?>
											<p class="badge border bg-dark"><label for="<?php echo $report1['report_desc']; ?>" id="<?php echo $report1['report_desc']; ?>" class="<?php echo $report1['report_desc']; ?>  control-label open-model" data-toggle="modal" data-target="#exampleModal"><span class="label-text"><?php echo 'Details of the samples Analysed by chemist'; ?></span></label></p><?php
										} 
										else if($report1['report_desc'] == 'Consolidated statement of Brought forward and carried forward of samples') { ?>
											<p class="badge border bg-dark"><label for="<?php echo $report1['report_desc']; ?>" id="<?php echo $report1['report_desc']; ?>" class="<?php echo $report1['report_desc']; ?>  control-label open-model" data-toggle="modal" data-target="#exampleModal"><span class="label-text"><?php echo 'Monthly report of Carry forward and Brought forward'; ?></span></label></p><?php
										} 
										else { ?>
											<p class="badge border bg-dark"><label for="<?php echo $report1['report_desc']; ?>" id="<?php echo $report1['report_desc']; ?>" class="<?php echo $report1['report_desc']; ?>  control-label open-model" data-toggle="modal" data-target="#exampleModal"><span class="label-text"><?php echo $report1['report_desc']; ?></span></label></p><?php
										} ?>											
									<?php  }
									endforeach; ?>
								</div>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
			...
			<div class="modal-header">
				<h6 class="modal-title" id="label-title"></h6>
