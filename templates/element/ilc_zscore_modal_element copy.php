  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLongTitle"> Z-Score <?php echo $_SESSION['user_flag']; ?> - <?php echo $_SESSION['ro_office']; ?></h5>
		...
		<?php echo $this->Form->create(); ?>
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<P><b> Commodity </b> <?php echo $getcommodity['category_name']; ?>   </p>
					</div>
					<div class="col-md-3">
