...
<div class="col-md-8  col-md-offset-2">
	...
	<h5>PAO/DDO Email ID</h5>
				...
				<?php echo $this->Form->control('pao_email_id', array('type'=>'text', 'id'=>'pao_email_id', 'value'=>$selected_pao_email_id['email'], 'label'=>false, 'readonly'=>true, 'class'=>'form-control')); ?>	
	...
	<div class="col-md-3">
				...
				<?php echo $this->Form->submit('Edit PAO/DDO', array('name'=>'edit_pao', 'id'=>'add_pao_btn', 'onclick'=>'set_pao_validation();return false', 'label'=>false, 'class'=>'form-control', 'style'=>'margin-top: 49px;float: left;')); ?>
