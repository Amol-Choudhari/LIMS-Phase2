												...
												<?php										
													if (isset($ilc_sample_reports)) {	
														...
														<tr>
															...
															<td class="text-center"><?php echo $this->Html->link('', array('controller' => 'FinalGrading', 'action'=>'ilcSampleZscoreRedirect', trim($res2['stage_smpl_cd'])),array('class'=>'glyphicon glyphicon-share','title'=>'finalized result submited by RAL/CAL')); ?></td>
