...
<?php echo $this->Html->css('master/phy_appear'); ?>
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-3"><?php echo $this->Html->link('Back', array('controller' => 'master', 'action'=>'reference-master-home'),array('class'=>'add_btn btn btn-secondary')); ?></div>
			<div class="col-sm-9">
					...
					<?php echo $this->Form->create(null, array('id'=>'frm_phy_appear', 'name'=>'categoryForm','class'=>'form-group')); ?>
						<div class="card card-lims">
							...
							<div class="card-footer mt-4">
								<?php if(isset($_SESSION['phy_appear_code']) && isset($_SESSION['phy_appear_data'])){
