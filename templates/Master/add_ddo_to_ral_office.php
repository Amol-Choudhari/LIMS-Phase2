    ...
    <div class="content-header">
        ...
        <section class="content form-middle">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $this->Form->create(null, array('id'=>'add_ddo', 'name'=>'add_ddo','class'=>'form-group')); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <?php echo $this->Form->control('ral_office_id', array('type'=>'select', 'id'=>'ral_office_id', 'label'=>false, 'options'=>$get_labs,'class'=>'form-control','empty'=>'---Select---')); ?>
                                                <div class="error invalid-feedback" id="error_ral_office_id"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <label>DDO List <span class="required-star">*</span></label>
                                                <?php echo $this->Form->control('ddo_id', array('type'=>'select', 'id'=>'ddo_id', 'label'=>false, 'options'=>$ddolist,'class'=>'form-control','empty'=>'---Select---')); ?>
                                                <div class="error invalid-feedback" id="error_ddo_id"></div>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Posted Office : </label>
                                                <div id="posted_office"></div>
                                                <div class="error invalid-feedback" id="error_posted_office"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
