...
?>
	...
	<div class="content-header">
												...
												<div class="row" id="update_div">
													...
													<div class="col-md-3">
														<div class="form-group">		
															<div class="col-md-14">
																<?php echo $this->Form->control('test', array('type'=>'select','options'=>$test_names, 'empty'=>'---select---','label'=>false,'class'=>'form-control','required'=>true,
																	'id'=>'select_test')); ?>	
															</div>
														</div>
													</div>	
         ...
         <!---- <div class="row">
                <div class="col-lg-12 text-center" >
                  <span>
                    ...
                    <span>
                        <button class="btn btn-primary"  id="Save" onclick="save_click()" >Save</button>
                    </span>
                    <span>
                        <button class="btn btn-primary" id="update" disabled >Edit</button>
                    </span>
                    <span>
                        <button class="btn btn-primary" onclick="delete_commodity_category()" id="delete" disabled>Delete</button>
                    </span>
                    <span>
                        <button class="btn btn-primary" id="Cancel" >Cancel</button>
                    </span>
                    <span>
                        <button class="btn btn-primary" id="View" disabled>View</button>
                    </span>
                    <span>
        ...
        <br>
        <table id="form1" class="dnone">
		</table>
		<table id="form2" class="dnone">
		</table>
			<div class="col-md-12">
				<div class="card-body">
