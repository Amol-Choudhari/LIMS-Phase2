								...
								<div class="card-header"><h3 class="card-title-new">Generate Letter</h3></div>
									<div class="form-horizontal">
										<div class="card-body">
											<div class="row">
												<div class="col-md-12">
													<p><b>Note: Please generate <?php echo count($subsamplelist); ?> letters as you have forwarded this sample to <?php echo count($subsamplelist); ?> of RAL's</b></p>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="inputEmail3" class="col-sm-4 col-form-label">Sample Code <span class="required-star">*</span></label> 
															<div class="custom-file col-sm-9">
																<?php echo $this->Form->control('stage_sample_code', array('type'=>'select', 'id'=>'stage_sample_code', 'options'=>$subsamplelist, 'label'=>false,'empty'=>'--Select--','class'=>'form-control','required'=>true,'onchange'=>'getsampledetails();return false',)); ?>	
