						...
						<div class="card card-lims">
							...
							<div class="card-footer mt-2">
								<div class="col-md-1 float-left">
									<?php echo $this->Form->submit('Reject Sample', array('name'=>'sample_reject', 'id'=>'sample_reject', 'label'=>false,'class'=>'btn btn-success')); ?>
								</div>
								<div class="col-md-1 float-right">
									<a href="../SampleForward/available_to_forward_list" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</div>
