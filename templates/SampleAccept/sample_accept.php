										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="custom-file col-sm-6">
														<?php echo $this->Form->control('actual_received_qty', array('type'=>'number	', 'id'=>'actual_received_qty', 'value'=>'', 'label'=>false,'class'=>'form-control','required'=>true,)); ?>
														<span id="error_received_quantity" class="error invalid-feedback"></span>
													</div>
												</div>
											</div>
														...
														<div class="col-sm-12">
															<div id="abc">
																<div class="form-group row">
																	...
																	<?php echo $this->Form->control('acceptstatus_remark', array('type'=>'textarea', 'id'=>'acceptstatus_remark',/*'onchange'=>'disable_save_btn();return false;',*/ 'label'=>false,'class'=>'form-control'/*,'required'=>true*/)); ?>
																	<div id="error_rej_reason"></div>
																</div>
															</div>
														</div>
