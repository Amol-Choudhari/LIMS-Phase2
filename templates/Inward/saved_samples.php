														...
														<?php if(!empty($sampleArray)){
															...
															foreach($sampleArray as $each){ ?>
																<tr>
																	...
																	<td><?php if ($each['inward_section'] == 'Y') { echo '<i class="fas fa-check cpcg mleft"></i>'; } else { echo '<i class="fas fa-times mleft cpcr"></i>'; } ?></td>
																	<td><?php if ($each['details_section'] == 'Y') { echo '<i class="fas fa-check cpcg mleft"></i>'; } else { echo '<i class="fas fa-times mleft cpcr"></i>'; } ?></td>
																	<td><?php if ($each['sample_type_code'] == '3' && $each['payment_section'] == 'Y') { echo '<i class="fas fa-check cpcg mleft"></i>'; } 
																		  elseif ($each['sample_type_code'] == '3' && $each['payment_section'] == '') { echo '<i class="fas fa-times mleft cpcr"></i>'; } else { echo '<span class="badge badge-info mleft28">N/A</span>'; }  ?></td>
																	<td>
																		<?php
													...
													if (!empty($sampleArray)) {
														...
														foreach ($sampleArray as $each) { ?>
															<tr>
																...
																<td><?php if ($each['inward_section']  == 'Y') { echo '<i class="fas fa-check cpcg mleft"></i>'; } else { echo '<i class="fas fa-times mleft cpcr"></i>';} ?></td>
																<td><?php if ($each['sample_type_desc'] == 'Commercial' && $each['payment_section'] == 'Y') { echo '<i class="fas fa-check cpcg mleft"></i>'; } 
																		  elseif ($each['sample_type_desc'] == 'Commercial' && $each['payment_section'] == '') { echo '<i class="fas fa-times mleft cpcr"></i>'; } else { echo '<span class="badge badge-info mleft28">N/A</span>'; }  ?></td>
