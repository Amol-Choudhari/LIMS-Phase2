						...
						<div class="col-md-12">
							<div class="col-md-12"><?php echo $this->element('/progress_bars/sample_registration_progress'); ?></div>
								<div class="card card-lims">
									<div class="card-header"><h3 class="card-title-new">Sample Details</h3></div>
															...
															<div class="col-md-12 row">
																...
																<div class="col-md-3">
																	<label>Sample Type <span class="required-star">*</span></label>
																		<?php echo $this->Form->control('sample_type_code', array('type'=>'select', 'id'=>'sample_type_code', 'options'=>$Sample_Type,'empty'=>'--Select--', 'value'=>$sample_Details_data['sample_type_code'], 'label'=>false,'class'=>'form-control','required'=>true)); ?>
