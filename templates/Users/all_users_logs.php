   ...
   <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6"><label class="badge badge-info">All User Logs</label></div>
                     <div class="col-sm-6">
                     ...
                     <div class="col-md-12">
                        <?php echo $this->Form->create(); ?>
                           <div class="card card-Lightblue">
                              <div class="card-header"><?php if(!empty($from_dt) && !empty($to_dt)){ ?>
                                                   ...
                                                   $i=0;
                                                      ...
                                                      foreach ($user_logs as $user_log) { ?>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td><?php echo base64_decode($user_log['email_id']);?></td>
